        ...
        <Dialog.Panel className="md:w-1/2 md:p-0 p-5">
          ...
          >
            ...
            <div className="mx-20 mt-12">
              ...
              <p className="mt-2 d">
                With ToDo you can create tasks that you need to complete and
                keep track of when they need to be completed. You can also give
                these tasks a cattegory to filter them quickly.
              </p>
              <p className="mt-2 d">ToDo is made with react and firebase.</p>
