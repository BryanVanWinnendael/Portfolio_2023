        ...
        <Dialog.Panel className="md:w-1/2 md:p-0 p-5">
          ...
          >
            ...
            <div className="mx-20 mt-12">
              ...
              <p className="mt-2 d">
                With Clne you can share your favorite moments in a form of a
                picture with your friends.
              </p>
              <p className="mt-2 d">Clne is made with react and firebase.</p>
              ...
              <div className="flex gap-5">
                <div>
                  ...
                  <p
                    ...
                    onClick={() =>
                      window.open("https://clne.netlify.app", "_blank")
                    }
                  >
                ...
                <div>
                  ...
                  <p
                    ...
                    onClick={() =>
                      window.open(
                        "https://github.com/BryanVanWinnendael/Clone",
                        "_blank"
                      )
                    }
                  >
